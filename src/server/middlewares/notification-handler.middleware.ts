...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'seo_status.update': {
    roles: ['business-owner', 'marketing-manager', 'seo-specialist'],
    key: 'seo-status-update',
    tenantPath: ['organization', 'seo_status'],
    userPath: [],
  },
  'seo_strategy.update': {
    roles: ['business-owner', 'marketing-manager', 'seo-specialist', 'content-creator'],
    key: 'seo-strategy-update',
    tenantPath: ['organization', 'seo_strategy'],
    userPath: [],
  },
  'content.create': {
    roles: ['business-owner', 'marketing-manager', 'seo-specialist'],
...
const tenantRoles: string[] = ['business-owner', 'marketing-manager', 'seo-specialist', 'content-creator'];

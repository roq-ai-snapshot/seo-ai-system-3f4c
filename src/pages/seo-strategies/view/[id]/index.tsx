...
import { getSeoStrategyById } from 'apiSdk/seo-strategies';
import { SeoStrategyInterface } from 'interfaces/seo-strategy';

function SeoStrategyViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('seo_strategy', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/seo-strategies/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Strategy" text={data?.strategy} />

                <FormListItem label="Goals" text={data?.goals} />

                <FormListItem label="Tactics" text={data?.tactics} />

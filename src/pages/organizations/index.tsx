...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'content.count', 'guest.count', 'seo_status.count', 'seo_strategy.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('guest', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('seo_status', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'seo_status',
          header: 'Seo Status',
          accessorKey: 'seo_status',
          cell: ({ row: { original: record } }: any) => record?._count?.seo_status,
        }
      : null,
    hasAccess('seo_strategy', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'seo_strategy',
          header: 'Seo Strategy',
          accessorKey: 'seo_strategy',
          cell: ({ row: { original: record } }: any) => record?._count?.seo_strategy,
        }
      : null,

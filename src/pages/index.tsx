...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`SEO AI system`}</title>

        <meta
          name="description"
          content="Experience the future of marketing with SEO AI System, your intelligent partner for optimized search engine results."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1562577309-2592ab84b1bc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxTRU98ZW58MHx8fHwxNjkzMTk5ODUxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@merakist?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Merakist`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of marketing with SEO AI System, your intelligent partner for optimized search engine results.`}
            </Text>
            <Box
